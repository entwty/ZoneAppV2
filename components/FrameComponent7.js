...
const FrameComponent7 = memo(({ style }) => {
  return (
    <View style={[styles.frameParent, style]}>
      <View style={styles.groupPosition}>
        <View style={styles.groupPosition}>
          ...
          <Text style={[styles.ay1, styles.ayTypo]}>₺12,90/ay</Text>
          <Text style={[styles.text1, styles.textFlexBox]}>₺78,90</Text>
          <Text style={[styles.ndrm, styles.ayTypo]}>%22 İNDİRİM</Text>
        </View>
      </View>
