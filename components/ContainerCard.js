...
const ContainerCard = () => {
  return (
    <View style={styles.greenStatusParent}>
      ...
      <Text style={[styles.time, styles.timeLayout]}>5 saat önce</Text>
      <Text style={[styles.message, styles.nameTypo]}>Yazıyor...</Text>
      <Text style={[styles.name, styles.nameTypo]}>Büşra Yıldız</Text>
      <Image
